...
SUPPLY_CHAIN_GRAPH = GraphData(
    nodes=[
        ...
        GraphNode(id="sup_45", label="TechParts Inc", type="Supplier", group=1, color="#4CAF50"),
        GraphNode(id="sup_23", label="GlobalMfg", type="Supplier", group=1, color="#4CAF50"),
        GraphNode(id="risk_12", label="Delivery Delay", type="Risk", group=2, color="#F44336"),
        GraphNode(id="risk_34", label="Quality Issues", type="Risk", group=2, color="#F44336"),
        GraphNode(id="risk_56", label="Price Volatility", type="Risk", group=2, color="#FF9800"),
        GraphNode(id="ship_01", label="Shipment #2401", type="Shipment", group=3, color="#2196F3"),
        GraphNode(id="ship_02", label="Shipment #2402", type="Shipment", group=3, color="#2196F3"),
